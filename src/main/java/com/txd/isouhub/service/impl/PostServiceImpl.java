package com.txd.isouhub.service.impl;
...
import com.txd.isouhub.constant.CommonConstant;
import com.txd.isouhub.exception.BusinessException;
import com.txd.isouhub.exception.ThrowUtils;
import com.txd.isouhub.mapper.PostFavourMapper;
import com.txd.isouhub.mapper.PostMapper;
import com.txd.isouhub.mapper.PostThumbMapper;
...
import com.txd.isouhub.model.entity.PostFavour;
import com.txd.isouhub.model.entity.PostThumb;
import com.txd.isouhub.model.entity.User;
...
import com.txd.isouhub.utils.SqlUtils;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public Page<Post> searchFromEs(PostQueryRequest postQueryRequest) {
        ...
        // 构造高亮查询
        HighlightBuilder highlightBuilder = new HighlightBuilder().fragmentSize(800000)
                .numOfFragments(0);
        ...
        NativeSearchQuery searchQuery = new NativeSearchQueryBuilder().withQuery(boolQueryBuilder)
                .withPageable(pageRequest).withSorts(sortBuilder).withHighlightBuilder(highlightBuilder)
                .build();
    ...
    @Override
    public Page<PostVO> listPostVOPage(Page<Post> postPage, HttpServletRequest request) {
